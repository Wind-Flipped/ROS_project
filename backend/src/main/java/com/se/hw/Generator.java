...
//                            .enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("D:/Abackend/hw/src/main/java/"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.se.hw") // 设置父包名
                            .moduleName("") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:/Abackend/hw/src/main/resources/mapper/")); // 设置mapperXml生成路径
                })
